  ...
  return (
    <section className='h-[100dvh] bg-[#00D54B] snap-start relative overflow-y-hidden'>
      <div className='absolute w-[100%] mob:!h-[100%] mob:top-[2%] revsmlap:top-[50%] left-[50%] -translate-x-[50%] revsmlap:-translate-y-[60%] smlap:top-[3%] flex flex-col gap-16 smlap:gap-12 mob:!gap-5 items-center z-50 mob:!justify-center'>
        ...
        <div className='mob:w-[86dvw] flex flex-row gap-20 smlap:gap-10 items-center mob:!flex-col mob:!justify-evenly mob:!pb-7'>
      ...
      <img 
        ...
        alt="Investing Floor" 
        className='absolute bottom-0 w-full mob:h-[46%] mob:hidden bg-white' 
      />
      <img 
      ...
      />
      <img 
        src="/assets/investing-graph-3.png" 
        alt="Investing Graph 2" 
        className='absolute right-[-50px] bottom-[8%] w-[420px] mob:hidden'
      />
      <img 
        src="/assets/investing-floor-mobile.png" 
      ...
      />
      <Footer themeColor={'white'} className="z-10"/>
    </section>
  )
}
